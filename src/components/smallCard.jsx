...
const SmallCard = ({
    ...
    return (
        <a
            ...
            target="_blank"
            rel="noreferrer"
            className="bg-[#112240] text-color2 flex flex-col mx-auto  px-4 py-6 rounded-md w-full md:max-w-[310px] lg:max-w-[300px] h-[320px] transform-gpu  transition duration-500 hover:-translate-y-1 mt-3"
        >
            {/* Header */}
            ...
            {/* heading */}
            <h2 className="text-lg text-color3 font-semibold font-popi pt-6">
                {name}
            </h2>
            {/* description */}
            ...
            <ul className="flex  flex-wrap  gap-x-3 w-full  ">
                {key_techs.map((tech) => (
                    <li
                        className="text-sm font-mono text-color2 capitalize font-medium"
                        key={tech}
                    >
                        {tech}
                    </li>
